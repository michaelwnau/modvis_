...
Revision ID: 64c2a977bbd3
Revises: ee1d432dbae0
Create Date: 2023-01-19 09:40:19.073719
...
revision = '64c2a977bbd3'
down_revision = 'ee1d432dbae0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('games', sa.Column('mods_url', sa.VARCHAR(length=255), nullable=True))
...
def downgrade():
    ...
    sa.Column('summmary', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    ...
    sa.Column('allow_ratings', sa.BOOLEAN(), autoincrement=False, nullable=False),
    ...
    sa.Column('endoresement_count', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('created_timestamp', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('created_time', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('updated_timestamp', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('updated_time', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('author', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('uploaded_by', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('uploaded_user_profile_url', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('contains_adult_content', sa.BOOLEAN(), autoincrement=False, nullable=False),
    ...
    sa.Column('user_member_id', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('user_member_group_id', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('user_name', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('endorsement', sa.TEXT(), autoincrement=False, nullable=True),
    sa.UniqueConstraint('mod_id', name='unq_trending_mods_mod_id')
    )
    ...
    sa.Column('nexusmods_url', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    ...
    sa.Column('mods_url', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
